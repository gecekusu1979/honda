...
namespace HondaTuner.Core.Localization
{
    public static class L
    {
        ...
        private static void LoadDefaults()
        {
            ...
            {
                _translations["safety_banner_lean"] = "🚨 FAKİR KARIÅIM ALGILANDI! AÅIRI HARARET / MOTOR KORUMAYA ALINDI!";
                _translations["safety_banner_overboost"] = "🚨 YÜKSEK BOOST ALGILANDI! MOTOR HASARI RİSKİ / BOOST KESİLDİ!";
                _translations["safety_banner_oil_temp"] = "🚨 YÜKSEK YAÄ SICAKLIÄI ALGILANDI! MOTOR LİMP MODUNA ALINDI!";
                _translations["safety_banner_low_oil_press"] = "🚨 KRİTİK DÜÅÜK YAÄ BASINCI ALGILANDI! MOTOR KORUMAYA ALINDI!";
                _translations["safety_banner_limits"] = "🚨 ACİL MOTOR KORUMA: LİMİTLER AÅILDI!";
        ...
        private static void LoadSharedDefaults()
        {
            ...
            AddShared("status_connected", "â— Bağlandı", "â— Connected");
            ...
            AddShared("ğŸ“ PROJE VE MOTOR META VERİLERİ", "ğŸ“ PROJE VE MOTOR META VERİLERİ", "ğŸ“ PROJECT AND ENGINE METADATA");
            ...
            AddShared("Åasi Numarası (VIN):", "Åasi Numarası (VIN):", "VIN Number:");
            ...
            AddShared("Åanzıman Tipi:", "Åanzıman Tipi:", "Gearbox Type:");
            ...
            AddShared("Åanzıman Vites Oranı:", "Åanzıman Vites Oranı:", "Gear Ratio:");
            ...
            AddShared("â• Dal Aç", "â• Dal Aç", "â• Open Branch");
            AddShared("Hafıza Commit Açıklaması:", "Hafıza Commit Açıklaması:", "Memory Commit Description:");
            AddShared("💾 Commit", "💾 Commit", "💾 Commit");
            AddShared("ğŸ” RAM Değer Watchdog (MCU Mercek)", "ğŸ” RAM Değer Watchdog (MCU Mercek)", "ğŸ” RAM Value Watchdog (MCU Lens)");
            AddShared("Canlı OBD1 Arıza Kodları (DTC)", "Canlı OBD1 Arıza Kodları (DTC)", "Live OBD1 Diagnostic Trouble Codes (DTC)");
            ...
            AddShared("alarm_injector_saturation", "🚨 KRİTİK: ENJEKTÖR DOYUMA ULAÅTI (%{0})!", "🚨 CRITICAL: INJECTOR SATURATED (%{0})!");
            ...
            AddShared("ECU Seri Numarası:", "ECU Seri Numarası:", "ECU Serial Number:");
            AddShared("Hardware Revizyonu:", "Hardware Revizyonu:", "Hardware Revision:");
            AddShared("Åasi Numarası (VIN):", "Åasi Numarası (VIN):", "Chassis Number (VIN):");
            AddShared("Kasa Kodu (Örn: EG6, EK4):", "Kasa Kodu (Örn: EG6, EK4):", "Chassis Code (e.g. EG6, EK4):");
            AddShared("Sıkıştırma Oranı (:1):", "Sıkıştırma Oranı (:1):", "Compression Ratio (:1):");
            AddShared("Eksantrik Profili:", "Eksantrik Profili:", "Camshaft Profile:");
            AddShared("Åanzıman Tipi:", "Åanzıman Tipi:", "Gearbox Type:");
            ...
            AddShared("💥 Hata Tetikle (Freeze Frame)", "💥 Hata Tetikle (Freeze Frame)", "💥 Trigger Fault (Freeze Frame)");
            AddShared("ğŸ“ ASAM MCD-2 MC (A2L) Kalibrasyon Standart Tanımları", "ğŸ“ ASAM MCD-2 MC (A2L) Kalibrasyon Standart Tanımları", "ğŸ“ ASAM MCD-2 MC (A2L) Calibration Standards");
            AddShared("💾 A2L Harita Dosyası (.a2l) İhraç Et", "💾 A2L Harita Dosyası (.a2l) İhraç Et", "💾 Export A2L Map File (.a2l)");
            ...
            AddShared("Åanzıman Vites Oranı:", "Åanzıman Vites Oranı:", "Gearbox Ratio:");
            AddShared("Ayna Mahruti Oranı:", "Ayna Mahruti Oranı:", "Final Drive Ratio:");
            AddShared("🚀 0 - 100 km/h Hızlanma:", "🚀 0 - 100 km/h Hızlanma:", "🚀 0 - 100 km/h Acceleration:");
            AddShared("✈️ 100 - 200 km/h Hızlanma:", "✈️ 100 - 200 km/h Hızlanma:", "✈️ 100 - 200 km/h Acceleration:");
            ...
            // VtecBoost / Alarm
            AddShared("wg_failure_alarm_prefix", "🚨 ÅARJ ALARMI:", "🚨 WG ALARM:");
            ...
            AddShared("ğŸ“  PROJE PARÇALARI", "ğŸ“  PROJE PARÇALARI", "ğŸ“  PROJECT PARTS");
            ...
            AddShared("msg_high_oil_temp", "🚨 YÜKSEK YAÄ SICAKLIÄI ({0}°C): Motor koruma modu devrede, RPM limiti {1} RPM.", "🚨 HIGH OIL TEMP ({0}°C): Engine protection active, RPM limit {1} RPM.");
            AddShared("msg_low_oil_press", "🚨 KRİTİK DÜÅÜK YAÄ BASINCI ({0} Bar): Motor hasar mekanizması nedeniyle YAKIT KESİLDİ!", "🚨 CRITICAL LOW OIL PRESS ({0} Bar): FUEL CUT to prevent engine damage!");
            AddShared("msg_low_fuel_press", "🚨 DÜÅÜK YAKIT BASINCI ({0} Bar): Yağlama basıncı yetersiz, avans geriye çekildi, limitler düşürüldü.", "🚨 LOW FUEL PRESS ({0} Bar): Unsafe pressure, timing retarded, limits reduced.");
            ...
            AddShared("msg_critical_egt", "â— CRITICAL EGT LIMIT ({0}°C): Avans kısılıyor (-{1}°), enjeksiyon %{2} zenginleştirilerek yanma ısısı düşürülüyor.", "â— CRITICAL EGT LIMIT ({0}°C): Timing reduced (-{1}°), fueling enriched by {2}% to lower temps.");
            ...
            AddShared("msg_ect_temp", "⚠️ ECT AÅIRI SICAKLIK ({0}°C): Avans -{1:0.0}° kısıldı (dinamik retard).", "⚠️ ECT OVERTEMP ({0}°C): Timing retarded -{1:0.0}° (dynamic retard).");
            ...
            AddShared("Aktif Dal (Branch):", "Aktif Dal (Branch):", "Active Branch:");
            AddShared("Yeni Dal Oluştur:", "Yeni Dal Oluştur:", "Create New Branch:");
            AddShared("â• Dal Aç", "â• Dal Aç", "â• New Branch");
            AddShared("Hafıza Commit Açıklaması:", "Hafıza Commit Açıklaması:", "Memory Commit Description:");
            AddShared("💾 Commit", "💾 Commit", "💾 Commit");
            AddShared("ğŸ” RAM Değer Watchdog (MCU Mercek)", "ğŸ” RAM Değer Watchdog (MCU Mercek)", "ğŸ” RAM Value Watchdog (MCU Lens)");
            AddShared("Değişken", "Değişken", "Variable");
            ...
            AddShared("diag_live_stream_ok", "[VERİ AKIÅI] 9600 bps OBD1 Aktif -> Son Okuma: BAÅARILI (Durum: {0})", "[DATA STREAM] 9600 bps OBD1 Active -> Last Read: SUCCESS (State: {0})");
            AddShared("1 (AKTİF)", "1 (AKTİF)", "1 (ACTIVE)");
            AddShared("0 (PASİF)", "0 (PASİF)", "0 (INACTIVE)");
            AddShared("â— Bağlı Değil", "â— Bağlı Değil", "â— Disconnected");
            ...
            AddShared("branch_merged", "\"{0}\" dalı \"{1}\" dalıyla BİRLEÅTİRİLDİ (MERGE).", "Branch \"{0}\" was MERGED into \"{1}\".");
        ...
        public static void LoadVehicleSelectionDefaults()
        {
            ...
            AddShared("veh_dialog_trans", "Åanzıman", "Transmission");
